...
class MelSpectrogram:
    def __init__(self, args):
        self.feature = Fbank(sample_rate=16000, n_fft=args.n_fft, n_mels=args.n_mels)
        self.normalize = InputNormalization(mean_norm=True, std_norm=False)

    def transform(self, x, lengths):
        return self.normalize(self.feature(x), lengths)    